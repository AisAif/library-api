...
describe('Auth', () => {
  ...
  it('POST /auth/register | should return 400 when field is blank', async () => {
  ...
  it('POST /auth/register | should return 400 when password not match', async () => {
    return request(app.getHttpServer())
      .post('/auth/register')
      .send({
        name: 'test',
  ...
  it('POST /auth/register | should return 400 when username already exists', async () => {
